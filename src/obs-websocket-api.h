...
/* Taken as-is from obs-websocket (lib/obs-websocket-api.h), the header
 * obs-websocket ships for plugins that add vendor requests of their own.
 * Reformatted to this project's clang-format style, otherwise unchanged. */
